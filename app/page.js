...
export default function Home() {
  return (
    <InnerLayout>
      <SectionTitleChip icon={<HomeIcon />} text="Introduction" />
      <div className="mt-3 sm:mt-5 lg:mt-[30px]">
        <h1 className="text-3xl sm:text-[40px] lg:text-[50px] xl:text-[60px] text-white font-medium tracking-[-3.6px] leading-tight">
          Hello! I am <span className="text-primary">Chidubem</span>.
        </h1> <Typewriter />
        <p className="md:max-w-[612px] w-full mt-4 lg:mt-6 commonPara">
            I build software, write code, and I love teaching.
          </p>
          <div className="my-10"></div> {/* This creates vertical space */}
          <p className="md:max-w-[612px] w-full mt-4 lg:mt-6 commonPara">
            And when I’m not coding or teaching, I’m busy soaking up life’s simple joys and finding new ways to learn and grow.
          </p>
